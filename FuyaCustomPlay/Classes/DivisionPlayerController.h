...
#import "ZFPlayer.h"
#import "DivisionPlayrProtocol.h"

NS_ASSUME_NONNULL_BEGIN

@interface DivisionPlayerController : NSObject
...
/// 可播放的视频的模型数组，若是混合区域，模型需要实现DivisionPlayable
/// set之后，先预加载几个
@property (nonatomic, copy) NSArray<id<DivisionPlayable>> *playableArray;
/// 当前正在播放的 MPPlayable 资源
@property (nonatomic, strong, readonly) id<DivisionPlayable> currentPlayable;
...
/**
 ...
 @return DivisionPlayerController实例
 */
